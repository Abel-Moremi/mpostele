import type { ColorSignal, PossibleColor, PossibleSpacing, PossibleVector2, Promisable, ReferenceReceiver, Signal, SignalValue, SimpleSignal, SimpleVector2Signal, SpacingSignal, ThreadGenerator, TimingFunction, Vector2Signal } from '@revideo/core';
...
export declare class Node implements Promisable<Node> {
    ...
    readonly properties: Record<string, import("..").PropertyMetadata<any>>;
    readonly key: string;
    ...
    [Symbol.iterator](): Generator<{
        meta: import("..").PropertyMetadata<any>;
