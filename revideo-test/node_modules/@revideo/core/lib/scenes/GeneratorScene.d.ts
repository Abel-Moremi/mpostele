...
import type { CachedSceneData, FullSceneDescription, Scene, SceneDescriptionReload, SceneRenderEvent } from './Scene';
...
export declare abstract class GeneratorScene<T> implements Scene<ThreadGeneratorFactory<T>>, Threadable {
    ...
    get onCacheChanged(): import("..").SubscribableValueEvent<CachedSceneData>;
    private readonly cache;
    get onReloaded(): import("..").Subscribable<void, import("..").EventHandler<void>>;
    private readonly reloaded;
    get onRecalculated(): import("..").Subscribable<void, import("..").EventHandler<void>>;
    private readonly recalculated;
    get onThreadChanged(): import("..").SubscribableValueEvent<Thread | null>;
    private readonly thread;
    get onRenderLifecycle(): import("..").Subscribable<[SceneRenderEvent, CanvasRenderingContext2D], import("..").EventHandler<[SceneRenderEvent, CanvasRenderingContext2D]>>;
    protected readonly renderLifecycle: EventDispatcher<[SceneRenderEvent, CanvasRenderingContext2D]>;
    get onReset(): import("..").Subscribable<void, import("..").EventHandler<void>>;
