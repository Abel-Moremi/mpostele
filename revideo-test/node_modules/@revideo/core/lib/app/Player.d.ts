...
export declare class Player {
     ...
     * @eventProperty
     */
    get onRender(): import("..").Subscribable<void, import("..").AsyncEventHandler<void>>;
    private readonly render;
    get onStateChanged(): import("..").SubscribableValueEvent<PlayerState>;
    private readonly playerState;
    get onFrameChanged(): import("..").SubscribableValueEvent<number>;
    private readonly frame;
    get onDurationChanged(): import("..").SubscribableValueEvent<number>;
