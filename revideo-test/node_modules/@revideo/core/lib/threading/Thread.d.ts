...
export declare class Thread {
     ...
     */
    readonly time: import("..").SimpleSignal<number, void>;
    /**
     ...
     */
    next(): IteratorYieldResult<void | ThreadGenerator | Promise<any> | import("./ThreadGenerator").Promisable<any>> | IteratorReturnResult<void> | {
        value: null;
        done: boolean;
    };
    /**
